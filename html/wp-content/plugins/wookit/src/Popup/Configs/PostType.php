...
$labels = [
    'name'                  => esc_html__('Tuyển sinh thạc sĩ', 'myshopkit-popup-smartbar-slidein'),
    'singular_name'         => esc_html__('Tuyển sinh thạc sĩ', 'myshopkit-popup-smartbar-slidein'),
    'menu_name'             => esc_html__('Tuyển sinh thạc sĩ', 'myshopkit-popup-smartbar-slidein'),
    'name_admin_bar'        => esc_html__('Tuyển sinh thạc sĩ', 'myshopkit-popup-smartbar-slidein'),
...
return [
	'label'              => esc_html__( 'Tuyển sinh thạc sĩ', 'myshopkit' ),
	'description'        => esc_html__( 'Tuyển sinh thạc sĩ', 'myshopkit' ),
	'labels'             => $labels,
	'public'             => true,
