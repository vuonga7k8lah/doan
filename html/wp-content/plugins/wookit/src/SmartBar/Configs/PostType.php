...
$aLabels = [
	'name'                  => esc_html__( 'Tuyển sinh tiến sĩ', 'myshopkit-popup-smartbar-slidein' ),
	'singular_name'         => esc_html__( 'Tuyển sinh tiến sĩ', 'myshopkit-popup-smartbar-slidein' ),
	'menu_name'             => esc_html__( 'Tuyển sinh tiến sĩ', 'myshopkit-popup-smartbar-slidein' ),
	'name_admin_bar'        => esc_html__( 'Tuyển sinh tiến sĩ', 'myshopkit-popup-smartbar-slidein' ),
	...
	'all_items'             => esc_html__( 'All Items', 'myshopkit-popup-smartbar-slidein' ),
	'add_new_item'          => esc_html__( 'Add New Item', 'myshopkit-popup-smartbar-slidein' ),
	'add_new'               => esc_html__( 'Add New', 'myshopkit-popup-smartbar-slidein' ),
	'new_item'              => esc_html__( 'New Item', 'myshopkit-popup-smartbar-slidein' ),
	'edit_item'             => esc_html__( 'Edit Item', 'myshopkit-popup-smartbar-slidein' ),
...
return [
	'label'              => esc_html__( 'Tuyển sinh tiến sĩ', 'myshopkit' ),
	'labels'             => $aLabels,
	'public'             => true,
