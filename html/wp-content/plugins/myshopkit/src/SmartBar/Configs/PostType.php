...
$aLabels = [
	'name'                  => esc_html__( 'Smart Bars', 'myshopkit-popup-smartbar-slidein' ),
	'singular_name'         => esc_html__( 'Smart Bar', 'myshopkit-popup-smartbar-slidein' ),
	'menu_name'             => esc_html__( 'Smart Bars', 'myshopkit-popup-smartbar-slidein' ),
	'name_admin_bar'        => esc_html__( 'Smart Bars', 'myshopkit-popup-smartbar-slidein' ),
