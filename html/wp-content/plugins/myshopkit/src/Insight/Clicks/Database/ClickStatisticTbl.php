...
namespace MyShopKitPopupSmartBarSlideIn\Insight\Clicks\Database;

class ClickStatisticTbl
{
	private static string $customerShopsTbl = 'customer_shops';
	public static string  $tblName          = MYSHOOKITPSS_PREFIX . 'click_statistic';
