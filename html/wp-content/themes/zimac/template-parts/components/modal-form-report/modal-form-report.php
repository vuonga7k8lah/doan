<?php
$modalId = 'wil-modal-form-report-comment--' . $args['id'];
?>
            ...
            <div class="bg-white rounded-2.5xl  w-[450px] max-w-full mx-auto text-xs md:text-base text-gray-700">
                <header class="flex items-baseline justify-between px-5 pt-3 space-x-3 overflow-hidden">
                    <div>
                        ...
                        <span>
                            <?php echo esc_html__('Please provide any additional information or context that will help us understand and handle the situation.', 'zimac'); ?>
                        </span>
                    </div>
                ...
                <div class="p-5 space-y-5">
                    ...
                    <form class="space-y-5" name="report-comment-form" method="POST" action="<?php echo esc_url(get_permalink()); ?>">
                        <input hidden type="hidden" id="report-comment-id" name="report-comment-id" value="<?php echo esc_attr($args['id']); ?>" />
                        <div class="wil-input relative">
                            <textarea id="report-message" name="report-message" aria-required="true" required class="h-32 md:h-36 py-3 px-5 border-2 border-gray-300 dark:border-gray-600 w-full rounded-[30px] placeholder-gray-600 bg-transparent text-xs md:text-base focus:border-primary focus:ring-0 font-medium" placeholder=" <?php echo esc_attr__('Reason ...', 'zimac'); ?>"></textarea>
                        </div>
                        ...
                        <div class="flex justify-end mt-8 space-x-3">
                            ...
                            <button name="report-comment-submit" type="submit" class="wil-button rounded-full h-14 w-full text-gray-900  bg-primary  text-xs lg:text-sm inline-flex items-center justify-center text-center py-2 px-4 md:px-5 font-bold focus:outline-none ">
                                <?php echo esc_html__('Report', 'zimac'); ?>
                            </button>
                        </div>
